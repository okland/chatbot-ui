...
export const Chat = memo(({ stopConversationRef }: Props) => {
  ...
  return (
    <div className="relative flex-1 overflow-hidden bg-white dark:bg-[#444654]">
      { modelError ? (
            ...
            {selectedConversation?.messages.length === 0 ? (
              <>
                <div className="mx-auto flex flex-col space-y-5 md:space-y-10 px-3 pt-5 md:pt-12 sm:max-w-[600px]">
                  <div className="text-center m-auto text-3xl font-semibold text-gray-800 dark:text-gray-100">
                    {models.length === 0 ? (
                      <div>
